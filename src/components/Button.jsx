...
const Button = () => {
  return (
    <a href="#_" class="relative inline-flex items-center px-12 py-1 overflow-hidden text-lg font-medium text-slate-100 border border-stone-600 rounded hover:text-white group hover:bg-gray-50">
